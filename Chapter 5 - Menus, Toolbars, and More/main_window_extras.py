...
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QCheckBox, QTextEdit, QDockWidget, QToolBar, QStatusBar, \
    QVBoxLayout
...
class MainWindow(QMainWindow):
    ...
    def setUpMainWindow(self):
        """ Create and arrange widgets in them ain window. """
    ...
    def createDockWidget(self):
        ...
        # create widget example to add to the dock
