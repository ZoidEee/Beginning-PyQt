...
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QLabel, QDockWidget, QPushButton, QDialog, QFileDialog, \
...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        ...
        self.print_act.setShortcut("Crtl+P")
        ...
        self.rotate180_act.triggered.connect(self.flipImageHorizontal)
        ...
        self.resize_act.setStatusTip("Resize image to hald the original size")
        self.resize_act.triggered.connect(self.resizeImageHalf)

        self.clear_act = QAction(
            QIcon("images/clear.png"), "Clear"
        )
        self.clear_act.setShortcut("Crtl+D")
    ...
    def createToolsDockWidget(self):
        ...
        use View -> Edit Image Tools menu to show/hide the dock. """
        ...
        # Create buttons foe editing images
        ...
        self.addDockWidget(
            Qt.DockWidgetArea.RightDockWidgetArea, dock_widget
        )
    ...
    def openImage(self):
        ...
        image_file, _ = QFileDialog.getOpenFileName(
            self, "Open Image", "", "JPG Files (*.jpeg *.jpg);;PNG Files (*.png);;\
    ...
    def saveImage(self):
        ...
        image_file, = QFileDialog.getSaveFileName(
            self, "Save Image", "",
    ...
    def rotateImage180(self):
        ...
        if self.image.isNull() == False:
            ...
            # the image, set the rototed image as self. image
            self.image = QPixmap(rotated)
            self.image_label.repaint()  # repaint the label
    ...
    def printImage(self):
        ...
        if print_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            # current view[prt, which is the image_label
