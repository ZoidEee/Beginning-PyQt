...
from PyQt6.QtWidgets import QApplication, QMainWindow, QMessageBox, QTextEdit, QFileDialog, QInputDialog, QFontDialog, \
    QColorDialog
...
class MainWindow(QMainWindow):
    ...
    def openFile(self):
        """ Open a text or html file and display it contents in the text edit field """
    ...
    def saveToFile(self):
        ...
        asking user if they want to save the text in the
        text edit field to as text or rich text file."""
    ...
    def chooseFont(self):
        """ Select a font from QFontDialog """
    ...
    def chooseFontColor(self):
        """ Select a font form the QColorDialog """
