...
class LoginWindow(QWidget):
    ...
    def setUpWindow(self):
        """ Create and arannge widgets in the main window. """
        ...
        # Create QCheckBox for displayin password
        ...
        sign_up_button.move(135, 180)
        sign_up_button.clicked.connect(self.createNewUser)

    def clickLoginButton(self):
        """ Check if username and password match any exusting
        entries in the users.txt.txt
        ...
        try:
            with open(file, 'r') as f:
                for line in f:
                    ...
                    password_info = user_info[1].rstrip("\n")
            ...
            QMessageBox.warning(self, "Error",
                                f"""<p>File not found.</p><p>Error: {error}</p>""",
                                QMessageBox.StandardButton.Ok)
    ...
    def closeEvent(self, event):
        """ Reimplement the closing evento to display a QMessageBox before closing. """
