...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        search_label = QLabel("Seath the index for an author: ", self)
    ...
    def searchAuthors(self):
        ...
        file = "Project/files/authors.txt"
        try:
            ...
            QMessageBox.warning(self, "Error", f"""<p>File Not Found</p><p>Error: {error}</p> Closing application""",
                                QMessageBox.StandardButton.Ok)
            self.close()
