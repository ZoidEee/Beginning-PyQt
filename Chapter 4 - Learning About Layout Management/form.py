...
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QDateEdit, QLineEdit, QTextEdit, QComboBox, \
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        # Organise widgets and layouts in QFormLayout
        ...
        main_form.addRow(QLabel("Comments of Messages"))
