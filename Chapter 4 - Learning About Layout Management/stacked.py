...
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QTextEdit, QComboBox, QSpinBox, QDoubleSpinBox, \
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        pg2_form.setFormAlignment(Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignLeft)
        pg2_form.setLabelAlignment(Qt.AlignmentFlag.AlignLeft)
        pg2_form.addRow("Breed: ", QLabel("Norwegian Forest cat"))
        pg2_form.addRow("Orgin: ", QLabel("Norway"))
        ...
        pg3_form.setFormAlignment(Qt.AlignmentFlag.AlignHCenter | Qt.AlignmentFlag.AlignLeft)
        ...
        # Create the stacked layour and add pages
