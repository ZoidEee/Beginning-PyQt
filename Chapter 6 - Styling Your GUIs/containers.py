...
from PyQt6.QtWidgets import QApplication, QWidget, QLabel, QRadioButton, QGroupBox, QLineEdit, QTabWidget, QHBoxLayout, \
    QVBoxLayout
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        # Create tab bar and different page container
        tab_bar = QTabWidget(self)
        self.prof_details_tab = QWidget()
        self.background_tab = QWidget()

        tab_bar.addTab(self.prof_details_tab, "Profile Detaile")
    ...
    def profileDetailsTab(self):
        """ Profile page allows the user to enter their name, address, and select their gender."""
        ...
        gender_rb = QGroupBox("Gender")
        gender_rb.setLayout(gender_h_box)
