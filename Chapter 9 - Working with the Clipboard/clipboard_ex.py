...
from PyQt6.QtWidgets import QApplication, QMainWindow, QPushButton, QTextEdit, QDockWidget, QFrame, QVBoxLayout
...
class MainWindow(QMainWindow):
    ...
    def createClipboardDock(self):
        """ Set up the clipboard and cock widget ot diplay
        ...
        dock_v_box.addWidget(self.central_tedit)
